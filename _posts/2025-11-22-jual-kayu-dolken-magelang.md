...
- Grabag (Grabag, Banyusari, Kleteran, Ngasinan, Sugihmas)
- Salaman (Salaman, Banjarharjo, Kalisalak, Kebonrejo)
keunggulan_produk:
- judul: Kualitas Premium Grade A
  deskripsi: Kayu dolken gelam pilihan berkualitas tinggi, sangat cocok untuk iklim
    sejuk Magelang di lereng Gunung Merapi dan Merbabu dengan ketinggian rata-rata
    380 mdpl. Tekstur padat dan kuat tahan curah hujan tinggi khas dataran tinggi
    Magelang.
  warna: warning
  icon: bi-award-fill
- judul: Harga Terbaik Se-Magelang
  deskripsi: Harga kompetitif mulai dari Rp 15.000/batang dengan kualitas terjamin.
    Dapatkan harga khusus untuk pembelian partai besar di wilayah Magelang Raya termasuk
    Mertoyudan, Muntilan, dan Borobudur.
  warna: danger
  icon: bi-cash-coin
- judul: Stok Selalu Ready
  deskripsi: Tersedia berbagai ukuran diameter 2-12 cm dengan stok melimpah. Siap
    kirim ke seluruh wilayah Magelang dari pusat kota hingga Borobudur dan Grabag.
  warna: info
  icon: bi-boxes
keunggulan_layanan:
...
- judul: COD & Bayar di Tempat
  deskripsi: Sistem pembayaran Cash on Delivery (COD) tersedia. Cek kualitas kayu
    terlebih dahulu sebelum bayar, aman dan tanpa risiko untuk customer di Magelang.
  warna: primary
  icon: bi-shield-check
- judul: Konsultasi Gratis 24/7
  deskripsi: Tim kami siap membantu konsultasi kebutuhan kayu dolken untuk proyek
    villa, homestay, atau pagar di Magelang. Hubungi kami kapan saja untuk solusi
    terbaik.
  warna: secondary
  icon: bi-headset
area_pengiriman_detail:
  judul_jangkauan: Jangkauan Pengiriman Luas ke Seluruh Magelang Raya
  deskripsi_jangkauan: Kami melayani pengiriman kayu dolken gelam ke seluruh wilayah
    Magelang mencakup Kota Magelang dan Kabupaten Magelang dengan 21 kecamatan. Gratis
  ...
  deskripsi_pengembangan: Wilayah Borobudur, Muntilan, dan Mertoyudan yang berkembang
    ...
    dolken berkualitas untuk konstruksi dan dekorasi bernuansa alam.
  judul_lainnya: Kecamatan Lainnya di Kabupaten Magelang
  judul_landmark: Landmark Strategis & Pusat Bisnis
  deskripsi_landmark: Kami melayani pengiriman ke area landmark terkenal Magelang
    seperti kawasan Candi Borobudur, Alun-Alun Magelang, dan kawasan bisnis utama.
    Ideal untuk proyek komersial, restoran, dan perhotelan.
  judul_wisata: Destinasi Wisata & Warisan Dunia
  deskripsi_wisata: Magelang adalah rumah bagi Candi Borobudur, warisan dunia UNESCO
    yang menarik jutaan wisatawan. Selain itu terdapat Candi Mendut, Candi Pawon,
    Punthuk Setumbu, dan kawasan wisata alam lereng Merapi yang membutuhkan material
    kayu berkualitas.
  judul_fasilitas: Fasilitas Pendidikan & Komersial
  deskripsi_fasilitas: Melayani kebutuhan institusi seperti Universitas Tidar Magelang
    dan Akademi Militer (AKMIL), serta pusat perbelanjaan seperti Armada Town Square
    dan Java Mall Magelang untuk berbagai kebutuhan konstruksi dan dekorasi.
  wilayah_pusat:
  - nama: Magelang Tengah
    kelurahan:
    - Cacaban, Kemirirejo, Magelang
    - Panjang, Rejowinangun Utara
    warna: primary
  - nama: Magelang Utara
    kelurahan:
    - Kramat Utara, Kramat Selatan, Potrobangsan
    - Wates, Kedungsari
    warna: success
  - nama: Magelang Selatan
    kelurahan:
    - Jurangombo Utara, Jurangombo Selatan
    - Rejowinangun Selatan, Tidar Utara, Tidar Selatan
    warna: info
  wilayah_utara_selatan:
  - nama: Mertoyudan (Kabupaten Magelang)
    kelurahan:
    - Banyuurip, Bondowoso, Deyangan
    - Jogonegoro, Kalinegoro, Mertoyudan
    warna: danger
  - nama: Muntilan (Kabupaten Magelang)
    kelurahan:
    - Muntilan, Gondosuli, Keji
    - Ngawen, Pucungrejo, Sriwedari, Tanjung
    warna: primary
  wilayah_pengembangan:
  - nama: Borobudur
    kelurahan:
    - Borobudur, Candirejo, Ngadiharjo
    - Wanurejo, Tuksongo, Karangrejo
    warna: primary
  - nama: Grabag
    kelurahan:
    - Grabag, Banyusari, Kleteran
    - Ngasinan, Sugihmas, Kartoharjo
    warna: info
  - nama: Salaman
    kelurahan:
    - Salaman, Banjarharjo, Kalisalak
    - Kebonrejo, Menoreh, Paripurno
    warna: wood
  - nama: Secang
    kelurahan:
    - Secang, Madusari, Donorejo
    - Ngadirejo, Candiretno, Donomulyo
    warna: success
  - nama: Tempuran
    kelurahan:
    - Tempuran, Girirejo, Kembanglimus
    - Mendongan, Ringinanom
    warna: warning
  kecamatan_lainnya:
  - Salam (Salam, Gulon, Kadiluwih, Sirahan, Sokorini)
  - Ngluwar (Ngluwar, Blongkeng, Jamuskauman, Somokaton)
  - Sawangan (Sawangan, Gantang, Kapuhan, Kragilan)
  - Dukun (Dukun, Banyubiru, Ngargomulyo, Sewukan)
  - Srumbung (Srumbung, Jerukagung, Kaliurang, Ngablak)
  - Candimulyo (Candimulyo, Bateh, Surodadi, Tempurejo)
  - Pakis (Pakis, Bawang, Daleman, Gondangsari)
  - Ngablak (Ngablak, Bandungrejo, Girirejo, Selomirah)
  landmark_wisata:
  ...
  - nama: Punthuk Setumbu
    icon: bi-tree
    warna: success
  - nama: Alun-Alun Magelang
    icon: bi-building
    warna: warning
  - nama: Museum Diponegoro
    icon: bi-building
    warna: warning
  - nama: Ketep Pass (Lereng Merapi)
    icon: bi-tree
    warna: success
  landmark_fasilitas:
  - nama: Armada Town Square (ATS)
    icon: bi-cart
    warna: info
  - nama: Java Mall Magelang
    icon: bi-cart
    warna: primary
  - nama: Universitas Tidar Magelang (UNTIDAR)
    icon: bi-mortarboard
    warna: success
  - nama: Akademi Militer (AKMIL)
    icon: bi-shield
    warna: warning
  - nama: RS Tidar Magelang
    icon: bi-hospital
    warna: info
  - nama: Politeknik Kesehatan Magelang
    icon: bi-mortarboard
    warna: success
...
- judul: Awet 20-30 Tahun
  deskripsi: Daya tahan luar biasa hingga 20-30 tahun tanpa treatment khusus. Sangat
    cocok untuk iklim sejuk Magelang di lereng Gunung Merapi dan Merbabu dengan suhu
    rata-rata 20-28°C dan curah hujan yang cukup tinggi.
  warna: success
  icon: bi-clock-history
- judul: Anti Rayap Natural
  deskripsi: Tidak memerlukan obat anti rayap karena tekstur kayu yang sangat padat
    secara alami menolak serangan rayap. Ideal untuk area lembab di Magelang khususnya
    kawasan wisata Borobudur dan lereng gunung.
  warna: danger
  icon: bi-bug
- judul: Tahan Cuaca Ekstrem
  deskripsi: Cocok untuk outdoor maupun indoor, tahan terhadap hujan deras dan kelembaban
    tinggi khas dataran tinggi Magelang. Tidak mudah lapuk meskipun terkena hujan
    dan embun terus menerus.
  warna: primary
  icon: bi-cloud-rain
- judul: Kuat & Padat Maksimal
  deskripsi: Kepadatan kayu sangat tinggi memberikan kekuatan maksimal untuk menahan
    ...
    villa maupun homestay di area wisata Magelang.
  warna: warning
  icon: bi-hammer
- judul: Ramah Lingkungan
  deskripsi: Material natural 100% sustainable dan biodegradable. Mendukung konsep
    eco-tourism dan green building yang banyak diterapkan di proyek-proyek wisata
    modern di kawasan Borobudur dan sekitarnya.
  warna: success
  icon: bi-recycle
- judul: Estetika Natural Premium
  deskripsi: Warna coklat natural yang indah memberikan kesan hangat dan alami. Sangat
    cocok untuk dekorasi homestay, villa wisata, dan resort alam di kawasan Borobudur
    dan lereng Merapi Magelang.
  warna: info
  icon: bi-palette
aplikasi_kayu_dolken:
  deskripsi: Kayu dolken gelam sangat fleksibel dan dapat diaplikasikan untuk berbagai
    kebutuhan konstruksi dan dekorasi di Magelang.
  konstruksi_dekorasi:
  - judul: Konstruksi & Bangunan
    icon: bi-building
    warna: wood
    aplikasi:
    - Tiang utama gazebo & pergola villa wisata
    - Struktur penyangga atap homestay & penginapan
    - Pondasi bangunan dan pagar tradisional
    - Rangka konstruksi rumah joglo dan limasan
  ...
  - judul: Dekorasi & Landscaping
    ...
    - Dekorasi villa dan homestay bernuansa alam
    - Elemen landscaping taman wisata
    - Pembatas area parkir outdoor
    - Aksen natural untuk warung makan & resto
  furniture_komersial:
  - judul: Furniture & Kerajinan
    ...
    - Rangka kursi & meja taman wisata
    - Kerajinan tangan khas Magelang
    - Aksesoris dekorasi natural homestay
    - Standing display warung dan toko souvenir
  - judul: Klien Komersial Terpercaya
    icon: bi-briefcase-fill
    warna: success
    deskripsi: Dipercaya oleh berbagai klien komersial untuk proyek-proyek berkualitas
      di Magelang dan kawasan wisata Borobudur.
    aplikasi:
    - Hotel & resort di kawasan Borobudur
    - Homestay & villa di lereng Merapi
    - Restoran di area Alun-Alun Magelang
    - Toko souvenir & pusat oleh-oleh
    - Developer perumahan Mertoyudan
...
studi_kasus_proyek:
  proyek_komersial:
  - judul: Gazebo & Pergola Resort di Kawasan Borobudur
    tahun: '2024'
    deskripsi: Pembangunan gazebo dan pergola untuk resort bintang 3 di kawasan wisata
      Borobudur. Klien membutuhkan material yang tahan terhadap kelembaban tinggi
      dan cocok untuk nuansa alam khas Magelang.
    jumlah: 190 batang
    diameter: 8-10 cm
    hasil: Struktur gazebo kokoh dan estetis menyatu dengan alam sekitar Borobudur.
      Klien sangat puas dengan tampilan natural dan ketahanan kayu setelah 1 tahun
      pemakaian.
    warna: primary
    icon: bi-building
  - judul: Homestay & Penginapan di Lereng Merapi
    tahun: '2024'
    deskripsi: Proyek pembangunan homestay wisata alam di lereng Gunung Merapi area
      Magelang. Menggunakan kayu dolken untuk tiang, pagar, dan seluruh elemen dekorasi
      natural.
    jumlah: 150 batang
    diameter: 6-8 cm dan 8-10 cm
    hasil: Homestay tampil natural dan autentik, sangat diminati wisatawan. Pemilik
      memuji daya tahan kayu terhadap kelembaban dan suhu dingin lereng Merapi.
    warna: warning
    icon: bi-house-door
  - judul: Pergola Resto di Jalan Pemuda Magelang
    tahun: '2024'
    deskripsi: Pembangunan pergola outdoor untuk restoran keluarga di Jalan Pemuda
      Magelang. Membutuhkan material premium yang tahan lama dan cocok untuk nuansa
      kota sejuk Magelang.
    jumlah: 120 batang
    diameter: 8-10 cm
    hasil: Pergola kokoh dan indah, menambah nilai estetika restoran. Customer puas
      dengan finishing natural yang hangat dan tahan cuaca.
    warna: success
    icon: bi-shop
  - judul: Dekorasi Toko Souvenir di Borobudur
    tahun: '2024'
    deskripsi: Instalasi dekorasi kayu untuk toko souvenir dan pusat oleh-oleh di
      kawasan wisata Candi Borobudur. Menggunakan kayu dolken untuk elemen display
      dan dekorasi bernuansa tradisional.
    jumlah: 80 batang
    diameter: 4-6 cm dan 6-8 cm
    hasil: Toko tampil lebih autentik dan menarik wisatawan mancanegara. Material
      kayu bertahan prima meski terkena hujan dan sinar matahari bergantian.
    warna: danger
    icon: bi-shop
  proyek_residensial:
  - judul: Pagar & Taman Rumah di Mertoyudan
    tahun: '2024'
    deskripsi: Pemasangan pagar dan border taman untuk perumahan baru di Mertoyudan
      Magelang. Area perumahan berkembang membutuhkan kayu yang tahan rayap dan tahan
      lama di iklim sejuk Magelang.
    jumlah: 140 batang
    diameter: 6-8 cm
    hasil: Pagar kokoh dan estetis, tahan cuaca sejuk Magelang. Pemilik rumah sangat
      puas dengan kualitas dan tampilan natural yang elegan.
    warna: success
    icon: bi-house-door
  - judul: Gazebo Rumah di Muntilan
    tahun: '2024'
    deskripsi: Pembangunan gazebo taman untuk rumah tinggal di area Muntilan Magelang.
      Klien menginginkan material yang kuat, awet, dan cocok untuk iklim sejuk lereng
      Merapi.
    jumlah: 85 batang
    diameter: 8-10 cm
    ...
    warna: success
    icon: bi-sun
  - judul: Taman Rumah di Magelang Selatan
    tahun: '2024'
    deskripsi: Dekorasi taman dan border landscape untuk rumah tinggal di Magelang
      Selatan. Menggunakan kayu dolken untuk aksen natural yang selaras dengan karakter
      kota Magelang.
    jumlah: 65 batang
    diameter: 4-6 cm
    ...
    warna: info
    icon: bi-tree-fill
  - judul: Villa Wisata di Kawasan Grabag
    tahun: '2024'
    deskripsi: Pembangunan villa wisata alam di kawasan Grabag Magelang yang sejuk.
      Pemilik menginginkan tampilan natural premium yang menyatu dengan alam pegunungan.
    jumlah: 110 batang
    diameter: 8-10 cm
    hasil: Villa tampil memukau dengan nuansa alam yang kuat. Tamu villa sangat terkesan
      dengan keindahan dan kenyamanan material kayu alami.
    warna: success
    icon: bi-house-heart-fill
  proyek_publik:
  - judul: Fasilitas Wisata di Kawasan Candi Borobudur
    tahun: '2023'
    deskripsi: Proyek pembuatan gazebo dan fasilitas istirahat untuk wisatawan di
      kawasan Candi Borobudur. Membutuhkan material yang tahan lama, minim perawatan,
      dan selaras dengan nuansa candi bersejarah.
    jumlah: 200 batang
    diameter: 8-10 cm dan 10-12 cm
    hasil: Gazebo wisata kokoh dan estetis, digunakan ribuan wisatawan domestik dan
      mancanegara. Setelah 1 tahun masih prima tanpa perawatan khusus.
    warna: info
    icon: bi-signpost-2
  - judul: Taman Kota di Alun-Alun Magelang
    tahun: '2023'
    deskripsi: Revitalisasi area hijau dan landscaping di sekitar Alun-Alun Magelang.
      Menggunakan kayu dolken untuk border, gazebo kecil, dan dekorasi taman publik.
    jumlah: 130 batang
    diameter: 6-8 cm
    hasil: Area taman lebih tertata dan estetis. Material kayu bertahan baik meski
      digunakan publik secara intens.
    warna: primary
    icon: bi-tree
...
- kategori: Dekorasi Ringan
  ...
  - Cocok untuk dekorasi taman dan homestay
...
- kategori: Struktur Sedang
  ...
  - Ideal untuk gazebo & pergola villa wisata
...
- kategori: Struktur Berat
  ...
  - Cocok untuk tiang utama resort & villa
  - Daya tahan ekstrem untuk proyek besar
  warna: danger
  icon: bi-building-fill
faq_pemesanan:
- pertanyaan: Berapa minimal pemesanan kayu dolken?
  jawaban: Kami melayani pemesanan mulai dari 10 batang saja. Untuk wilayah Magelang,
...
- pertanyaan: Apakah ada diskon untuk pembelian partai besar?
  jawaban: Ya, tersedia harga khusus untuk pembelian dalam jumlah besar. Untuk proyek
    resort, hotel, atau pengembang di kawasan Borobudur yang membutuhkan ratusan batang,
    kami berikan harga spesial. Hubungi tim kami untuk negosiasi harga terbaik.
  icon: bi-percent
faq_produk:
- pertanyaan: Apakah kayu dolken perlu perawatan khusus di Magelang?
  jawaban: Tidak perlu perawatan khusus. Kayu dolken gelam sangat cocok untuk iklim
    sejuk dan lembab Magelang. Untuk aplikasi outdoor di kawasan Borobudur atau lereng
    Merapi yang sering terkena hujan, Anda bisa tambahkan coating varnish untuk memperpanjang
    usia dan menjaga warna, tapi ini opsional.
  icon: bi-tools
- pertanyaan: Apakah bisa custom panjang kayu dolken?
  jawaban: Ya, bisa custom panjang sesuai kebutuhan proyek. Standar kami 4 meter,
    tapi bisa disesuaikan untuk proyek spesifik di Magelang seperti gazebo villa,
    pergola homestay, atau konstruksi resort wisata. Diskusikan kebutuhan Anda dengan
    tim kami di 081311400177.
  icon: bi-rulers
- pertanyaan: Bagaimana membedakan kayu dolken asli gelam dengan imitasi?
  ...
  icon: bi-patch-check
faq_pengiriman:
- pertanyaan: Berapa lama pengiriman ke Magelang?
  jawaban: Untuk area Magelang, pengiriman memakan waktu 1-3 hari kerja tergantung
    lokasi. Area pusat kota dan Mertoyudan biasanya 1-2 hari. Area pinggiran seperti
    Borobudur, Grabag, atau Salaman maksimal 3 hari kerja. Gratis ongkir untuk seluruh
    wilayah Magelang menggunakan armada terpercaya.
  icon: bi-truck
- pertanyaan: Apakah pengiriman bisa sampai ke kawasan Borobudur?
  jawaban: Ya, bisa! Kami melayani pengiriman hingga kawasan Candi Borobudur, Candirejo,
    Wanurejo, dan seluruh kecamatan Borobudur. Armada kami berpengalaman menangani
    pengiriman ke kawasan wisata Magelang. Tetap gratis ongkir untuk minimal pembelian
    tertentu.
  icon: bi-geo-alt
relevansi_kayu_dolken:
  ...
  aplikasi_lokal:
  - nama: Gazebo & pergola resort di kawasan wisata Candi Borobudur
    icon: bi-check-circle-fill
  - nama: Homestay & villa alam di lereng Gunung Merapi area Magelang
    icon: bi-check-circle-fill
  - nama: Pagar dan dekorasi perumahan baru di Mertoyudan dan Muntilan
    icon: bi-check-circle-fill
  - nama: Konstruksi outdoor di kawasan wisata Punthuk Setumbu dan Ketep Pass
    icon: bi-check-circle-fill
  - nama: Furniture taman untuk hotel dan penginapan di pusat kota Magelang
    icon: bi-check-circle-fill
tentang_kota:
  tagline: Kota Sejuta Bunga
  deskripsi_singkat: Kota bersejarah di jantung Jawa Tengah yang menjadi pintu gerbang
    menuju Candi Borobudur dan kawasan wisata lereng Gunung Merapi.
  overview: Magelang adalah kota yang terletak di Provinsi Jawa Tengah, dikelilingi
    oleh empat gunung berapi yaitu Merapi, Merbabu, Sumbing, dan Sindoro. Dengan luas
    wilayah Kota Magelang sekitar 18 km² dan populasi lebih dari 120.000 jiwa, serta
    Kabupaten Magelang seluas 1.086 km² dengan populasi lebih dari 1,3 juta jiwa,
    Magelang menjadi kawasan strategis di Jawa Tengah yang kaya akan potensi wisata
    dan pertanian.
  tentang_kota_1:
  - judul: Warisan Dunia & Wisata Budaya
    icon: bi-building
    subjudul: Rumah Candi Borobudur Warisan UNESCO
    icon_subjudul: bi-star-fill
    deskripsi: |-
      Magelang adalah rumah bagi Candi Borobudur, candi Buddha terbesar di dunia yang ditetapkan sebagai Warisan Dunia UNESCO pada tahun 1991. Dibangun pada abad ke-8 oleh Dinasti Syailendra, Borobudur adalah mahakarya arsitektur yang menarik jutaan wisatawan dari seluruh dunia setiap tahunnya. Kawasan Borobudur bersama Candi Mendut dan Candi Pawon membentuk segitiga suci yang menjadi pusat spiritual dan wisata budaya.

      Selain Borobudur, Magelang juga memiliki kekayaan sejarah militer yang unik. Akademi Militer (AKMIL) yang berdiri sejak 1945 menjadikan Magelang sebagai kota militer terkemuka di Indonesia. Museum Diponegoro yang menyimpan berbagai artefak Perang Jawa turut memperkaya khazanah sejarah kota ini. Perpaduan warisan budaya, sejarah, dan alam menjadikan Magelang destinasi wisata yang sangat lengkap.
    fakta:
    - Candi Borobudur adalah candi Buddha terbesar di dunia dengan 2.672 panel relief
    - Borobudur menarik lebih dari 3 juta wisatawan domestik dan mancanegara per tahun
    - Akademi Militer Magelang berdiri sejak 1945 dan menjadi kebanggaan nasional
  - judul: Alam & Agrowisata
    icon: bi-tree
    subjudul: Dikelilingi Gunung dan Hamparan Alam Subur
    icon_subjudul: bi-flower1
    deskripsi: |-
      Magelang dikelilingi empat gunung yang menjadikan kawasan ini salah satu yang paling subur di Jawa Tengah. Lereng Gunung Merapi dan Merbabu di sisi timur menawarkan panorama alam yang menakjubkan dengan kebun salak, tembakau, dan sayuran yang menjadi komoditas unggulan. Ketep Pass di lereng Merapi menjadi destinasi wisata alam favorit untuk menikmati pemandangan dua gunung sekaligus.
  ...
  - judul: Landmark & Ikon Kota
    icon: bi-pin-map
    subjudul: Tempat Bersejarah & Destinasi Favorit
    icon_subjudul: bi-star-fill
    deskripsi: 'Magelang memiliki berbagai landmark ikonik yang menjadi kebanggaan
      warga dan daya tarik wisatawan:'
    list_item:
    - "<strong>Candi Borobudur</strong> Candi Buddha terbesar di dunia, Warisan Dunia
      UNESCO, mahkota wisata Magelang"
    - "<strong>Candi Mendut & Pawon</strong> Candi pelengkap Borobudur yang membentuk
      jalur spiritual bersejarah"
    - "<strong>Akademi Militer (AKMIL)</strong> Institusi pendidikan militer bergengsi
      yang menjadi kebanggaan nasional"
    - "<strong>Alun-Alun Magelang</strong> Pusat kota yang dikelilingi bangunan bersejarah
      dan menjadi ruang publik utama warga"
    - "<strong>Museum Diponegoro</strong> Museum bersejarah yang menyimpan artefak
      perjuangan Pangeran Diponegoro"
    - "<strong>Punthuk Setumbu</strong> Bukit dengan pemandangan Borobudur dan sunrise
      yang memukau wisatawan dunia"
  - judul: Kuliner & Budaya Lokal
    icon: bi-cup-hot
    subjudul: Surga Kuliner Tradisional Jawa Tengah
    icon_subjudul: bi-heart-fill
    deskripsi: 'Magelang dikenal dengan kekayaan kuliner tradisional dan budaya lokal
      yang kental:'
    list_item:
    - "<strong>Kupat Tahu Magelang</strong> Kuliner ikonik khas Magelang yang terkenal
      di seluruh Jawa Tengah"
    - "<strong>Sop Senerek</strong> Sup kacang merah khas Magelang yang menjadi favorit
      warga dan wisatawan"
    - "<strong>Gethuk Trio</strong> Oleh-oleh khas berbahan singkong yang menjadi
      simbol kuliner Magelang"
    - "<strong>Festival Borobudur</strong> Event budaya tahunan bertaraf internasional
      di kompleks Candi Borobudur"
    - "<strong>Pasar Tradisional Rejowinangun</strong> Pusat perdagangan tradisional
      terbesar dan paling ramai di Magelang"
...
share_count: 0
total_updates: 1
last_modified_at: '2025-11-22 09:00:00 +0700'
---
