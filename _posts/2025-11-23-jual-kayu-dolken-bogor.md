...
- judul: Kualitas Premium Grade A
  deskripsi: Kayu dolken gelam pilihan berkualitas tinggi, sangat cocok untuk iklim
    basah Bogor yang dikenal sebagai Kota Hujan dengan curah hujan tertinggi di Jawa.
    Tekstur padat dan kuat tahan curah hujan ekstrem sepanjang tahun khas Bogor.
  warna: warning
  icon: bi-award-fill
- judul: Harga Terbaik Se-Bogor
  deskripsi: Harga kompetitif mulai dari Rp 15.000/batang dengan kualitas terjamin.
    Dapatkan harga khusus untuk pembelian partai besar di wilayah Bogor Raya termasuk
    Cibinong, Dramaga, dan kawasan Puncak.
  warna: danger
  icon: bi-cash-coin
- judul: Stok Selalu Ready
  deskripsi: Tersedia berbagai ukuran diameter 2-12 cm dengan stok melimpah. Siap
    kirim ke seluruh wilayah Bogor dari pusat kota hingga Dramaga dan Cibinong.
  warna: info
  icon: bi-boxes
keunggulan_layanan:
- judul: Gratis Ongkir Seluruh Bogor
  deskripsi: Nikmati pengiriman gratis untuk seluruh wilayah Bogor dari pusat kota
    hingga kawasan Puncak dan Dramaga. Hemat biaya transportasi untuk proyek Anda
    di Kota Hujan.
  warna: success
  icon: bi-truck
- judul: COD & Bayar di Tempat
  deskripsi: Sistem pembayaran Cash on Delivery (COD) tersedia. Cek kualitas kayu
    terlebih dahulu sebelum bayar, aman dan tanpa risiko untuk customer di Bogor.
  warna: primary
  icon: bi-shield-check
- judul: Konsultasi Gratis 24/7
  deskripsi: Tim kami siap membantu konsultasi kebutuhan kayu dolken untuk proyek
    villa, resort, atau pagar di Bogor. Hubungi kami kapan saja untuk solusi terbaik.
  warna: secondary
  icon: bi-headset
area_pengiriman_detail:
  judul_jangkauan: Jangkauan Pengiriman Luas ke Seluruh Bogor Raya
  ...
  deskripsi_utara_selatan: Bogor Utara berbatasan dengan Depok dan Cibinong dengan
    ...
    Puncak yang kaya villa dan resort wisata.
  judul_pengembangan: Area Pengembangan & Wisata Puncak
  deskripsi_pengembangan: Kawasan Puncak, Cisarua, Megamendung, dan Ciawi yang menjadi
    destinasi wisata utama Jabodetabek membutuhkan kayu dolken dalam jumlah besar
    untuk villa, resort, dan homestay bernuansa alam pegunungan.
  ...
  deskripsi_wisata: Bogor kaya akan destinasi wisata alam seperti Kebun Raya Bogor,
    ...
    Gunung Salak dan Halimun yang membutuhkan material kayu berkualitas.
  judul_fasilitas: Fasilitas Pendidikan & Komersial
  deskripsi_fasilitas: Melayani kebutuhan kampus seperti IPB University dan Universitas
    Pakuan, serta pusat perbelanjaan seperti Botani Square, Bogor Trade Mall, dan
    Lippo Plaza Ekalokasari untuk berbagai kebutuhan konstruksi dan dekorasi.
  wilayah_pusat:
  - nama: Bogor Tengah
    kelurahan:
    - Babakan, Babakan Pasar, Cibogor
    - Ciwaringin, Gudang, Kebon Kelapa, Pabaton, Paledang
    warna: primary
  - nama: Bogor Utara
    kelurahan:
    - Cibuluh, Ciluar, Kedung Halang
    - Kedung Waringin, Tegal Gundil, Tanah Baru
    warna: success
  - nama: Bogor Selatan
    kelurahan:
    - Batutulis, Bondongan, Empang
    - Harjasari, Lawanggintung, Muarasari, Pamoyanan
    warna: info
  - nama: Bogor Timur
    kelurahan:
    - Baranangsiang, Katulampa, Sindangrasa
    - Sindangsari, Tajur
    warna: warning
  - nama: Bogor Barat
    kelurahan:
    - Cilendek Barat, Cilendek Timur, Curug
    - Gunung Batu, Menteng, Pasir Kuda, Semplak
    warna: danger
  - nama: Tanah Sareal
    kelurahan:
    - Cikaret, Kedung Badak, Kebon Pedes
    - Kencana, Mekarwangi, Sukaresmi, Sukadamai
    warna: primary
  wilayah_utara_selatan:
  - nama: Cibinong (Kabupaten Bogor)
    kelurahan:
    - Cibinong, Cirimekar, Harapan Jaya
    - Karadenan, Nanggewer, Pakansari
    warna: danger
  - nama: Cisarua - Kawasan Puncak
    kelurahan:
    - Cisarua, Batulayang, Citapen
    - Jogjogan, Kopo, Leuwimalang, Tugu Selatan
    warna: primary
  wilayah_pengembangan:
  - nama: Dramaga
    kelurahan:
    - Babakan, Ciherang, Dramaga
    - Petir, Sinarsari, Neglasari, Cikarawang
    warna: primary
  - nama: Megamendung
    kelurahan:
    - Megamendung, Cipayung, Gadog
    - Kuta, Pasir Angin, Sukamanah
    warna: info
  - nama: Ciawi
    kelurahan:
    - Ciawi, Banjarwaru, Bendungan
    - Cileungsi, Citapen, Pandansari
    warna: wood
  - nama: Gunung Putri
    kelurahan:
    - Gunung Putri, Bojong Kulur, Cicadas
    - Ciangsana, Tlajung Udik, Wanaherang
    warna: success
  - nama: Cileungsi
    kelurahan:
    - Cileungsi, Cipeucang, Dayeuh
    - Gandoang, Limus Nunggal, Mampir
    warna: warning
  kecamatan_lainnya:
  - Leuwiliang (Leuwiliang, Barengkok, Karehkel, Kalong Liud)
  - Cibungbulang (Cibungbulang, Cimanggu, Dukuh, Galuga)
  - Pamijahan (Pamijahan, Ciasmara, Ciasihan, Citatah)
  - Caringin (Caringin, Cimande, Pancawati, Tangkil)
  - Cariu (Cariu, Cikutamahi, Tanjungsari)
  - Jonggol (Jonggol, Balekambang, Bendungan, Cibodas)
  - Parung (Parung, Bojong Sempu, Iwul, Jabon Mekar)
  - Kemang (Kemang, Bojong, Candali, Jampang)
  landmark_wisata:
  ...
  - nama: Curug Nangka
    icon: bi-water
    warna: primary
  - nama: Gunung Salak Endah
    icon: bi-tree
    warna: success
  - nama: Kawasan Wisata Puncak
    icon: bi-geo-alt
    warna: warning
  landmark_fasilitas:
  - nama: Botani Square Bogor
    icon: bi-cart
    warna: info
  - nama: Bogor Trade Mall (BTM)
    icon: bi-cart
    warna: primary
  - nama: Lippo Plaza Ekalokasari
    icon: bi-cart
    warna: info
  - nama: IPB University (Institut Pertanian Bogor)
    icon: bi-mortarboard
    warna: success
...
- judul: Awet 20-30 Tahun
  deskripsi: Daya tahan luar biasa hingga 20-30 tahun tanpa treatment khusus. Sangat
    cocok untuk iklim basah Bogor yang dikenal sebagai Kota Hujan dengan curah hujan
    rata-rata 3.500-4.000 mm per tahun, tertinggi di Pulau Jawa.
  warna: success
  icon: bi-clock-history
- judul: Anti Rayap Natural
  deskripsi: Tidak memerlukan obat anti rayap karena tekstur kayu yang sangat padat
    secara alami menolak serangan rayap. Ideal untuk iklim lembab Bogor yang menjadi
    habitat favorit rayap kayu dan jamur.
  warna: danger
  icon: bi-bug
- judul: Tahan Hujan Ekstrem
  deskripsi: Cocok untuk outdoor maupun indoor, tahan terhadap hujan deras dan kelembaban
    ekstrem khas Bogor. Tidak mudah lapuk meskipun terkena hujan hampir setiap hari
    sepanjang tahun.
  warna: primary
  icon: bi-cloud-rain
- judul: Kuat & Padat Maksimal
  deskripsi: Kepadatan kayu sangat tinggi memberikan kekuatan maksimal untuk menahan
    ...
    villa di kawasan Puncak dan sekitarnya.
  warna: warning
  icon: bi-hammer
- judul: Ramah Lingkungan
  deskripsi: Material natural 100% sustainable dan biodegradable. Mendukung konsep
    eco-tourism dan green building yang banyak diterapkan di proyek-proyek villa dan
    resort modern di kawasan wisata Bogor.
  warna: success
  icon: bi-recycle
- judul: Estetika Natural Premium
  deskripsi: Warna coklat natural yang indah memberikan kesan hangat dan alami. Sangat
    cocok untuk dekorasi villa, resort, dan homestay di kawasan Puncak dan Gunung
    Salak yang mengedepankan nuansa alam.
  warna: info
  icon: bi-palette
aplikasi_kayu_dolken:
  deskripsi: Kayu dolken gelam sangat fleksibel dan dapat diaplikasikan untuk berbagai
    kebutuhan konstruksi dan dekorasi di Bogor.
  konstruksi_dekorasi:
  - judul: Konstruksi & Bangunan
    icon: bi-building
    warna: wood
    aplikasi:
    - Tiang utama gazebo & pergola villa Puncak
    - Struktur penyangga atap homestay & resort
    - Pondasi bangunan dan pagar perumahan
    - Rangka konstruksi rumah kayu dan joglo
  ...
  - judul: Dekorasi & Landscaping
    ...
    - Dekorasi villa dan resort bernuansa alam
    - Elemen landscaping kebun dan taman wisata
  ...
  - judul: Furniture & Kerajinan
    ...
    warna: info
    aplikasi:
    - Material furniture outdoor tahan hujan
    - Rangka kursi & meja taman villa
    - Kerajinan tangan dan dekorasi
    - Aksesoris dekorasi natural homestay
    - Standing display cafe & warung makan
  - judul: Klien Komersial Terpercaya
    icon: bi-briefcase-fill
    warna: success
    deskripsi: Dipercaya oleh berbagai klien komersial untuk proyek-proyek berkualitas
      di Bogor dan kawasan wisata Puncak.
    aplikasi:
    - Hotel & resort di kawasan Puncak dan Cisarua
    - Villa & homestay di lereng Gunung Salak
    - Restoran di area Jalan Pajajaran Bogor
    - Cafe & kedai kopi di pusat kota Bogor
    - Developer perumahan Cibinong dan Dramaga
...
studi_kasus_proyek:
  proyek_komersial:
  - judul: Gazebo & Pergola Resort di Kawasan Puncak
    tahun: '2024'
    deskripsi: Pembangunan gazebo dan pergola untuk resort bintang 3 di kawasan Puncak
      Bogor. Klien membutuhkan material yang tahan terhadap hujan deras dan kelembaban
      ekstrem khas Bogor sepanjang tahun.
    jumlah: 210 batang
    diameter: 8-10 cm
    hasil: Struktur gazebo kokoh dan estetis menyatu dengan alam pegunungan Puncak.
      Klien sangat puas dengan ketahanan kayu terhadap curah hujan tinggi setelah
      1 tahun pemakaian.
    warna: primary
    icon: bi-building
  - judul: Villa & Homestay di Cisarua Bogor
    tahun: '2024'
    deskripsi: Proyek pembangunan villa wisata alam di Cisarua kawasan Puncak Bogor.
      Menggunakan kayu dolken untuk seluruh elemen kayu eksterior termasuk tiang,
      pergola, dan pagar dengan nuansa alam.
    jumlah: 165 batang
    diameter: 6-8 cm dan 8-10 cm
    hasil: Villa tampil natural dan autentik, diminati wisatawan dari Jakarta. Pemilik
      memuji daya tahan kayu terhadap hujan dan kelembaban ekstrem Puncak Bogor.
    warna: warning
    icon: bi-house-door
  - judul: Pergola Restoran di Jalan Pajajaran Bogor
    tahun: '2024'
    deskripsi: Pembangunan pergola outdoor untuk restoran keluarga di Jalan Pajajaran
      Bogor. Membutuhkan material premium tahan hujan untuk area outdoor dining di
      kota dengan curah hujan tertinggi di Jawa.
    jumlah: 135 batang
    diameter: 8-10 cm
    hasil: Pergola kokoh dan indah, menambah nilai estetika restoran. Customer puas
      dengan finishing natural yang tahan cuaca hujan Bogor sepanjang tahun.
    warna: success
    icon: bi-shop
  - judul: Dekorasi Cafe di Kawasan Kebun Raya Bogor
    tahun: '2024'
    deskripsi: Instalasi dekorasi kayu untuk cafe instagramable di dekat Kebun Raya
      Bogor. Menggunakan kayu dolken untuk elemen display, pagar taman, dan aksen
      dekorasi bernuansa alam.
    jumlah: 90 batang
    diameter: 4-6 cm dan 6-8 cm
    hasil: Cafe tampil lebih natural dan menarik pengunjung yang datang ke Kebun Raya.
      Material kayu bertahan prima meski terkena hujan hampir setiap hari.
    warna: danger
    icon: bi-cup-hot
  proyek_residensial:
  ...
  - judul: Gazebo Rumah di Dramaga Bogor
    tahun: '2024'
    deskripsi: Pembangunan gazebo taman untuk rumah tinggal di area Dramaga dekat
      IPB University. Klien menginginkan material kuat, awet, dan cocok untuk iklim
      hujan Bogor.
    jumlah: 90 batang
    diameter: 8-10 cm
    hasil: Gazebo berdiri kokoh dan indah, menjadi spot favorit keluarga. Setelah
      8 bulan tidak ada tanda-tanda kerusakan atau serangan rayap meski sering hujan.
    warna: success
    icon: bi-sun
  ...
  - judul: Pergola Villa di Megamendung Bogor
    tahun: '2024'
    deskripsi: Pembangunan pergola outdoor untuk villa pribadi di kawasan Megamendung
      Bogor. Pemilik menginginkan tampilan natural premium yang menyatu dengan alam
  ...
  proyek_publik:
  - judul: Fasilitas Taman di Kawasan Kebun Raya Bogor
    tahun: '2023'
    deskripsi: Proyek pembuatan gazebo dan fasilitas istirahat untuk pengunjung di
      kawasan sekitar Kebun Raya Bogor. Membutuhkan material tahan lama yang minim
      perawatan di iklim Bogor yang sangat lembab.
    jumlah: 180 batang
    diameter: 8-10 cm dan 10-12 cm
    hasil: Gazebo wisata kokoh dan estetis, digunakan ribuan pengunjung Kebun Raya.
      Setelah 1 tahun masih dalam kondisi prima tanpa perawatan khusus.
    warna: info
    icon: bi-tree
  - judul: Landscaping Taman Kencana Bogor
    tahun: '2023'
    deskripsi: Revitalisasi area hijau dan landscaping di Taman Kencana Bogor. Menggunakan
      kayu dolken untuk border, gazebo kecil, dan dekorasi taman publik yang tahan
      cuaca hujan.
    jumlah: 120 batang
    diameter: 6-8 cm
    hasil: Area taman lebih tertata dan estetis. Material kayu bertahan baik meski
      terkena hujan sangat intens khas Bogor.
    warna: primary
    icon: bi-signpost-2
...
- nama: Bu Astuti Widyawati
  ...
  rating: 5
  judul: Pelayanan Cepat & Memuaskan
  komentar: Order untuk pagar rumah di Dramaga dekat IPB, prosesnya mudah dan cepat.
    Tim nya membantu konsultasi kebutuhan dengan sabar dan detail. Kayu nya bagus,
    warna natural coklat cantik. Puas!
  warna: success
testimoni_komersial:
- nama: Pak Rizal Fauzi
  lokasi: Owner Villa di Kawasan Puncak Bogor
  rating: 5
  judul: Cocok untuk Villa Wisata
  komentar: Pakai kayu dolken untuk seluruh elemen kayu villa saya di Puncak Bogor.
    Tamu sangat suka dengan nuansa natural nya. Sudah 10 bulan masih bagus kondisi
    nya, tahan hujan deras Puncak yang hampir setiap hari. Mantap!
  warna: warning
- nama: Pak Gunawan Santoso
  lokasi: Kontraktor Villa di Bogor
  rating: 5
  judul: Partner Terpercaya untuk Proyek
  komentar: Sudah beberapa kali order untuk proyek villa dan resort di kawasan Puncak
    dan Cisarua. Kualitas konsisten bagus, stok selalu ready, dan pengiriman tepat
    waktu. Jadi partner supplier terpercaya saya untuk proyek Bogor.
  warna: info
- nama: Bu Sinta Maharani
...
- kategori: Dekorasi Ringan
  ...
  - Cocok untuk dekorasi taman dan cafe
...
- kategori: Struktur Sedang
  ...
  - Ideal untuk gazebo & pergola villa Puncak
...
- pertanyaan: Berapa minimal pemesanan kayu dolken?
  jawaban: Kami melayani pemesanan mulai dari 10 batang saja. Untuk wilayah Bogor,
...
- pertanyaan: Apakah kayu dolken perlu perawatan khusus di Bogor?
  jawaban: Tidak perlu perawatan khusus. Kayu dolken gelam sangat cocok untuk iklim
    basah Bogor dengan curah hujan tertinggi di Jawa. Untuk aplikasi outdoor yang
    terkena hujan sangat intens seperti di kawasan Puncak, Anda bisa tambahkan coating
    varnish untuk memperpanjang usia dan menjaga warna, tapi ini opsional.
  icon: bi-tools
- pertanyaan: Apakah bisa custom panjang kayu dolken?
  jawaban: Ya, bisa custom panjang sesuai kebutuhan proyek. Standar kami 4 meter,
    tapi bisa disesuaikan untuk proyek spesifik di Bogor seperti gazebo villa Puncak,
    pergola resort, atau konstruksi homestay. Diskusikan kebutuhan Anda dengan tim
    kami di 081311400177.
  icon: bi-rulers
...
- pertanyaan: Apakah pengiriman bisa sampai ke kawasan Puncak dan Cisarua?
  jawaban: Ya, bisa! Kami melayani pengiriman hingga kawasan Puncak, Cisarua, Megamendung,
    dan seluruh area wisata di Kabupaten Bogor. Armada kami berpengalaman menangani
    pengiriman ke kawasan pegunungan. Tetap gratis ongkir untuk minimal pembelian
    tertentu.
  icon: bi-geo-alt
relevansi_kayu_dolken:
  karakteristik_iklim: Bogor dikenal sebagai Kota Hujan dengan curah hujan rata-rata
  ...
  aplikasi_lokal:
  - nama: Gazebo & pergola villa dan resort di kawasan wisata Puncak dan Cisarua
    icon: bi-check-circle-fill
  - nama: Homestay & penginapan alam di lereng Gunung Salak dan Halimun
    icon: bi-check-circle-fill
  - nama: Pagar dan dekorasi perumahan baru di Cibinong dan Dramaga
    icon: bi-check-circle-fill
  - nama: Dekorasi cafe & restoran di kawasan Kebun Raya dan Jalan Pajajaran
    icon: bi-check-circle-fill
  - nama: Furniture taman untuk hotel dan resort di kawasan Puncak Bogor
    icon: bi-check-circle-fill
tentang_kota:
  tagline: Kota Hujan
  deskripsi_singkat: Kota bersejarah di kaki Gunung Salak yang dikenal sebagai Kota
  ...
  - judul: Sejarah & Warisan Kolonial
    icon: bi-clock-history
    subjudul: Kota Bersejarah dengan Warisan Buitenzorg
    icon_subjudul: bi-book
    deskripsi: |-
      Bogor memiliki sejarah panjang sebagai kota peristirahatan raja-raja pada era Kerajaan Sunda dan kemudian menjadi pusat administrasi kolonial Belanda. Dikenal dengan nama Buitenzorg yang berarti "tanpa kekhawatiran" dalam bahasa Belanda, Bogor menjadi tempat peristirahatan favorit para pejabat kolonial berkat iklimnya yang sejuk dan pemandangan alam yang indah.
  ...
  - judul: Wisata Alam & Kawasan Puncak
    ...
    deskripsi: |-
      Kawasan Puncak di Kabupaten Bogor adalah destinasi wisata alam paling populer di Jabodetabek. Setiap akhir pekan, jutaan warga Jakarta berbondong-bondong menuju Puncak untuk menikmati udara sejuk, pemandangan kebun teh, dan berbagai wahana wisata alam. Ribuan villa, resort, dan homestay tersebar di sepanjang jalur Puncak dari Ciawi hingga Cipanas menjadikan kawasan ini sebagai pusat pariwisata terbesar di Jawa Barat.

      Selain Puncak, Bogor juga memiliki beragam destinasi wisata alam lainnya seperti Taman Safari Indonesia di Cisarua, Curug Nangka, Gunung Salak Endah, dan kawasan agrowisata Gunung Mas. Kebun Raya Bogor sebagai taman botani seluas 87 hektar menjadi destinasi wisata ilmiah dan rekreasi yang dikunjungi jutaan orang setiap tahun.
    fakta:
    - Kawasan Puncak menerima lebih dari 2 juta pengunjung setiap akhir pekan
    - Taman Safari Indonesia di Cisarua adalah taman safari terbesar di Asia Tenggara
    - Kebun Raya Bogor memiliki lebih dari 12.000 koleksi tanaman dari seluruh dunia
  tentang_kota_2:
  - judul: Pendidikan & Penelitian
    icon: bi-mortarboard
    subjudul: Pusat Ilmu Pengetahuan & Penelitian Pertanian
    icon_subjudul: bi-book-fill
    deskripsi: 'Bogor dikenal sebagai kota ilmu pengetahuan dengan berbagai lembaga
      penelitian dan pendidikan tinggi berkelas dunia:'
    list_item:
    - "<strong>IPB University</strong> Universitas pertanian terbaik di Indonesia
  ...
  - judul: Kuliner & Oleh-Oleh Khas
    icon: bi-cup-hot
    subjudul: Surga Kuliner dengan Cita Rasa Sunda Autentik
